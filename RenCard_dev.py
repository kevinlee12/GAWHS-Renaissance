#-------------------------------------------------------------------------------
# Name:        RenCard
# Purpose:     Renaissance Card Counter and Sorter
#
# Author:      leekevin
#
# Created:     04/11/2013
...
def gpa():
    home.destroy()
    gpa_win = Frame(win,bg='white',bd = 0)
    gpa_win.pack()
...
welcome = Label(home, text = 'Renaissance Card Sorter', foreground ='dark red',background ='white', font = 'Arial 16')
welcome.grid(row = 0 , column = 0)
